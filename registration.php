		...
		<div class="container">
			...
			<div class="row">
				<div class="col-sm-3">
					...
					<input class="form-control" id="areacode"  type="text" name="areacode" required>
		...
		$('#register').click(function(e){
			...
			var gender 		= $('#gender').val();
				...
				$.ajax({
					type: 'POST',
					url: 'process.php',
					data: {firstname: firstname,lastname: lastname,email: email,areacode: areacode,phonenumber: phonenumber,address: address,password: password,confirmpassword: confirmpassword,gender: gender},
